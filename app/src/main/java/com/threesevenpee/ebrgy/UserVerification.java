...
public class UserVerification extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner = findViewById(R.id.spinnerUserVerificationMaritalStatus);
